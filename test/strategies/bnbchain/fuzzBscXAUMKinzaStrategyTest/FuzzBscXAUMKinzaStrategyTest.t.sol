...
contract FuzzBscXAUMKinzaStrategyTest is TestUtils {
    ...
    function _reRunFailedSequence() internal {
        handler.allocate(52200402235278686831593534981796866219364682465706455831321307458335844335615);
        handler.invest(2329164700002907406005249199258364045202, 14493679);
        handler.redeem(925404296873887042388699207668220282525405683029437934751757);
        handler.collect(8897);
        handler.redeem(137612438987143309889717552725197628033141232927596304);
        handler.invest(5787154949, 176143737282728514787091330963450);
        handler.redeem(243050133710697263902870635796461782601749980428070542815275561757);
        handler.invest(130274120946151423436542231, 23);
        handler.collect(1750314154010535516378790139781722831);
        handler.collectAll();
        invariant_allocationLimits();
    }
